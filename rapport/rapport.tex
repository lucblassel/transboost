...
\paragraph{}La suite est celle de l’algorithme Adaboost\cite{boosting} (voir ~\ref{ada}). A noter que l’erreur totale du modèle est mesurée sur le set de validation. Par contre le modèle est bien entraîné sur le set d’entraînement pondéré, et la pondération des points basée sur les prédictions faites sur ce même set d’entraînement.\\
...
%
%   \bibitem{transboost}
%     {Cornuejols A. , Akkoyunlu S. , Murena P.A., Olivier R.},
%     Transfer Learning by boosting projections from the target domain to the source domain
%
%   \bibitem{keras}
%     Chollet F.,
%     Building powerful image classification models using very little data,
%     \href{\url{https://blog.keras.io/building-powerful-image-classification-models-using-very-little-data.html}},
%     2016
%
% \end{thebibliography}
